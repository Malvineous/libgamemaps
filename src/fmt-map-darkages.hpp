/**
 * @file  fmt-map-darkages.hpp
 * @brief MapType and Map2D implementation for Dark Ages maps.
 *
...
#ifndef _CAMOTO_GAMEMAPS_MAP_DARKAGES_HPP_
#define _CAMOTO_GAMEMAPS_MAP_DARKAGES_HPP_
...
class MapType_DarkAges: virtual public MapType
{
	public:
...
#endif // _CAMOTO_GAMEMAPS_MAP_DARKAGES_HPP_
