...
#ifndef _CAMOTO_GAMEMAPS_MAP_NUKEM2_HPP_
#define _CAMOTO_GAMEMAPS_MAP_NUKEM2_HPP_
...
/// Duke Nukem II level reader/writer.
class MapType_Nukem2: virtual public MapType_Base
{
	public:
...
#endif // _CAMOTO_GAMEMAPS_MAP_NUKEM2_HPP_
