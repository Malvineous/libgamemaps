...
#ifndef _CAMOTO_GAMEMAPS_MAP_DUKE1_HPP_
#define _CAMOTO_GAMEMAPS_MAP_DUKE1_HPP_
...
class MapType_Duke1: virtual public MapType
{
	public:
...
#endif // _CAMOTO_GAMEMAPS_MAP_DUKE1_HPP_
