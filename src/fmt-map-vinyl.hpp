...
#ifndef _CAMOTO_GAMEMAPS_MAP_VINYL_HPP_
#define _CAMOTO_GAMEMAPS_MAP_VINYL_HPP_
...
/// Vinyl Goddess From Mars level reader/writer.
class MapType_Vinyl: virtual public MapType_Base
{
	public:
...
#endif // _CAMOTO_GAMEMAPS_MAP_VINYL_HPP_
