...
#ifndef _CAMOTO_GAMEMAPS_MAP_GOT_HPP_
#define _CAMOTO_GAMEMAPS_MAP_GOT_HPP_
...
/// God of Thunder level reader/writer.
class MapType_GOT: virtual public MapType
{
	public:
...
#endif // _CAMOTO_GAMEMAPS_MAP_GOT_HPP_
