...
class test_map_wordresc: public test_map2d
{
	public:
		...
		void addTests()
		{
			...
			// Attribute 00: BG colour
			this->changeAttribute(0, 5, STRING_WITH_NULLS(
				"\x03\x00" "\x05\x00"
				"\x05\x00"
				"\x02\x00"
				"\x03\x00"
			...
			// Attribute 01: Tileset
			this->changeAttribute(1, 3, STRING_WITH_NULLS(
				"\x03\x00" "\x05\x00"
				"\x04\x00"
				"\x04\x00"
				"\x03\x00"
			...
			// Attribute 02: Backdrop
			this->changeAttribute(2, 0, STRING_WITH_NULLS(
				"\x03\x00" "\x05\x00"
				"\x04\x00"
				"\x02\x00"
				"\x00\x00"
